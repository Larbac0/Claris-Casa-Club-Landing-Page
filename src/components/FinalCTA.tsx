  ...
  if (response.ok) {
      ...
      if (typeof window !== "undefined" && (window as any).fbq) {
        (window as any).fbq("track", "Lead", {
          content_name: "Claris Casa & Clube Contact Form",
          value: 1,
          currency: "BRL",
        });
      }
